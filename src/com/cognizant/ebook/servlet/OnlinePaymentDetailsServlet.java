...
/**
 * Servlet implementation class OnlinePaymentDetailsServlet
 */
@WebServlet("/OnlinePaymentDetails")
public class OnlinePaymentDetailsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (null != session.getAttribute("sessionAlive")) {
			...
			long cardNumber = Long
					.parseLong(request.getParameter("cardNumber"));
			...
			Order ord = new Order(ordId, ordFullName, email, address, city,
					state, zip, cardName, cardNumber, expMonth, expYear, cvv,
					modeOfPayment, total);
